...
$settings['file_private_path'] = 'sites/patasdacasa/private';

$settings['config_sync_directory'] = 'sites/patasdacasa/sync/';

// Trusted host patterns.
$settings['trusted_host_patterns'][] = '^.*\.local\.site$';

$settings['file_temp_path'] = 'sites/patasdacasa/files/tmp';
